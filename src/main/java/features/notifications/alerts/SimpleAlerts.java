package features.notifications.alerts;

import features.notifications.popup.GlassPanePopup;
import features.notifications.popup.component.GlassPaneChild;
import features.notifications.popup.component.PopupCallbackAction;
import features.notifications.popup.component.PopupController;
import features.notifications.swing.AnimateIcon;
...
public class SimpleAlerts extends GlassPaneChild {
    ...
    protected class PanelEffect extends JPanel {
        ...
        protected Component createCloseButton() {
            JButton cmdClose = new JButton(new FlatSVGIcon("Pictures/Icon/Pics1/close.svg", 0.8f));
