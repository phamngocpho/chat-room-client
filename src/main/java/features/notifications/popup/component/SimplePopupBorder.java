package features.notifications.popup.component;
...
public class SimplePopupBorder extends GlassPaneChild {
    ...
    private final SimplePopupBorderOption option;
    ...
    protected Component createBackButton() {
        JButton cmdBack = new JButton(new FlatSVGIcon("Pictures/Icon/Pics1/back.svg", 0.8f));
